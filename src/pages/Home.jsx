...
//       // Map over items to adjust image path for locally stored images
//       const updatedData = data.map(item => ({
//         ...item,
//         image: item.image.startsWith("/uploads/")
//           ? `http://localhost:5000${item.image}` // Convert relative path to absolute
//           : item.image // Keep external URLs as they are
//       }));
...
//               category={item.category}
//               description={item.description}
//               image={item.image} // Correct image path handled above
//             />
//           ))
//         ) : (
//           <p>Loading food items...</p>
